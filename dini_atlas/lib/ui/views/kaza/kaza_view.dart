...
class KazaView extends StackedView<KazaViewModel> with $KazaView {
      ...
      body: Center(
        child: ListView(
          ...
          children: [
            ...
            viewModel.authType == AuthType.login
                ? _loginWidget(viewModel)
                : _registerWidget(viewModel),
            verticalSpace(60),
            _changeActionTypeWidget(
              viewModel: viewModel,
              type: viewModel.authType,
            )
          ],
        ),
      ),
  ...
  Widget _loginWidget(KazaViewModel viewModel) {
    return Column(
      ...
      children: [
        ...
        verticalSpace(40),
        _actionButton(text: "Giriş Yap", onPressed: () {}),
      ],
    );
  }
  ...
  Widget _registerWidget(KazaViewModel viewModel) {
    return Column(
      ...
      children: [
        ...
        verticalSpace(40),
        _actionButton(text: "Kayıt Ol", onPressed: () {}),
      ],
    );
  }
  ...
  @override
  void onDispose(KazaViewModel viewModel) {
