...
import 'package:dini_atlas/models/favourite.dart' as _i23;
import 'package:dini_atlas/models/quran/sura_info.dart' as _i21;
...
class QuranViewArguments {
  ...
  final _i21.SuraInfo sura;

  final _i22.QuranTabs currentTab;
...
class FavouritesViewArguments {
  ...
  final _i23.Favourite? favourite;
...
extension NavigatorStateExtension on _i24.NavigationService {
  ...
  Future<dynamic> navigateToQuranView({
    _i20.Key? key,
    required _i21.SuraInfo sura,
    required _i22.QuranTabs currentTab,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
