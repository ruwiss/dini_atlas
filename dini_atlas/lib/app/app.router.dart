...
import 'package:dini_atlas/models/favourite.dart' as _i21;
import 'package:dini_atlas/models/quran/sura_info.dart' as _i19;
...
class QuranViewArguments {
  ...
  final _i19.SuraInfo sura;

  final _i20.QuranTabs currentTab;
...
class FavouritesViewArguments {
  ...
  final _i21.Favourite? favourite;
...
extension NavigatorStateExtension on _i22.NavigationService {
  ...
  Future<dynamic> navigateToQuranView({
    _i18.Key? key,
    required _i19.SuraInfo sura,
    required _i20.QuranTabs currentTab,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
